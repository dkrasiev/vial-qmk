...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_TAB , MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_D), MT(MOD_LCTL, KC_F), KC_G, KC_H , MT(MOD_RCTL, KC_J), MT(MOD_RSFT, KC_K), MT(MOD_RALT, KC_L), MT(MOD_RGUI, KC_SCLN), KC_QUOT,
        _______, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                            KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, _______,
                          _______, _______, _______, LOWER  , KC_SPC ,          KC_ENT , RAISE  , _______, _______, _______
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, _______, KC_HOME, _______, KC_END , KC_INS ,                            KC_PGUP, KC_7   , KC_8   , KC_9   , _______, _______,
        _______, LANG   , _______, _______, _______,KC_ENT ,                            KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT,LANG   , _______,
        _______, SEARCH , PREVWRD, KC_CAPS, NEXTWRD, KC_DEL ,                            KC_PSCR, KC_1   , KC_2   , KC_3   , SEARCH , _______,
                          QK_BOOT, _______, _______, _______, _______,          _______, ADJUST , _______, KC_0   , _______
    ),
