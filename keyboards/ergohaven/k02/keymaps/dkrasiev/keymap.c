...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        SEARCH , _______, KC_LEFT, KC_DOWN, KC_RIGHT,KC_ENT ,                            KC_PGDN, KC_4   , KC_5   , KC_6   , _______, SEARCH ,
        LANG   , _______, PREVWRD, KC_CAPS, NEXTWRD, KC_DEL ,                            KC_PSCR, KC_1   , KC_2   , KC_3   , _______, LANG   ,
                          _______, _______, _______, _______, QK_BOOT,          _______, ADJUST , _______, KC_0   , _______
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        SEARCH , KC_BSLS, KC_LPRN, KC_MINS, KC_RPRN, KC_PLUS,                            KC_PERC, KC_LCBR, KC_SCLN, KC_RCBR, KC_EXLM, SEARCH ,
        LANG   , _______, KC_ASTR, KC_COLN, KC_SLSH, _______,                            _______, KC_PIPE, KC_TILD, KC_AMPR, _______, LANG   ,
                          _______, _______, _______, ADJUST , _______,          QK_BOOT, _______, _______, _______, QK_RBT
    ),
