...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        SEARCH , _______, KC_LEFT, KC_DOWN, KC_RIGHT,KC_ENT ,                            KC_PGDN, KC_4   , KC_5   , KC_6   , _______, _______,
        LANG   , _______, PREVWRD, KC_CAPS, NEXTWRD, KC_DEL ,                            KC_PSCR, KC_1   , KC_2   , KC_3   , _______, _______,
