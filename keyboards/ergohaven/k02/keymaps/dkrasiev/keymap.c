...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_TAB , MT(MOD_LSFT, KC_A), MT(MOD_LGUI, KC_S), MT(MOD_LALT, KC_D), MT(MOD_LCTL, KC_F), KC_G,                           KC_H   , MT(MOD_RCTL, KC_J), MT(MOD_RALT, KC_K), MT(MOD_RGUI, KC_L), MT(MOD_RSFT, KC_SCLN), KC_QUOT,
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, LANG , KC_LEFT, KC_DOWN, KC_RIGHT,KC_ENT ,                            KC_PGDN, KC_4   , KC_5   , KC_6   , LANG   , _______,
